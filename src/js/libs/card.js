...
if($('.card-wrapper-set').length > 0){
	var card = new Card({
		form: '.form-credi-cart',
		container: '.card-wrapper-set',
	
		formSelectors: {

			numberInput: 'input[id="credi_cart_number"]',
			expiryInput: 'input[id="credi_cart_expiry"]',
			nameInput:'input[id="credi_cart_name"]',
			cvcInput:'input[id="credi_cart_cvc"]'
