...
var bdy = $('body'),
    ...
    customLog = function (o) {
        if (window.location.href.indexOf('debugmode=true') != -1 && o['state'] == false)
            console.log('yüklenmeyen plugin', o['key']);
    },
    checkPlugins = function (key) {
        var b = false;
        if (typeof $.fn[key] !== 'undefined')
            b = true;

        customLog({ state: b, key: key });
    ...
    uty = {
        ...
        unVeil: function (o) {
            ...
            if (_t.detectEl(ID) && checkPlugins('unveil')) {
                ID.unveil();
                if (trigger)
                    ID.trigger('unveil');
            }
    ...
    plugin = {
        ...
        videos: {
            ...
            initPlugins: function (o) {
                ...
                if (typeof MediaElementPlayer !== 'undefined') {
                    ...
                    customLog({ state: false, key: 'MediaElementPlayer' });
            },
            set: function () {
                var _t = this;
                $(_t.el.con)
        ...
        */
        zoomGallery: {
            ...
            init: function () {
                var _t = this;
                if (checkPlugins('minusZoomGallery'))
                    _t.set(_t.arr);
            }
        },
        ...
        */
        socialShare: {
            ...
            init: function () {
                var _t = this;
                if (checkPlugins('minusSocialShare'))
                    _t.set(_t.arr);
            }
        },
        ...
        */
        loadMoreButton: {
            ...
            adjust: function () {
                ...
                if (uty.detectEl(el) && checkPlugins('minusLoadMoreButton'))
                    el.each(function () {
                        var ths = $(this);
            ...
            init: function () {
                var _t = this;
                if (checkPlugins('minusLoadMoreButton'))
                    _t.set(_t.arr);
            }
        },
        ...
        */
        html5Video: {
            ...
            adjust: function () {
                ...
                if (uty.detectEl(el) && checkPlugins('minusHTML5Video'))
                    el.each(function () {
                        var ths = $(this);
                        if (ths.hasClass(_t.cls['active'])) {
                            ths = ths.get(0);
            ...
            init: function () {
                ...
                if (uty.detectEl(con) && checkPlugins('minusHTML5Video'))
                    con
                        .each(function () {
                            _t.set($(this));
                        });
        ...
        */
        lazyLoad: {
            el: {
                ...
                con: '[data-background]:visible:not(".image-loaded"):not(".lazy-swiper"), [data-image-src]:visible:not(".image-loaded"):not(".lazy-swiper"), [data-srcset]:visible:not(".image-loaded"):not(".lazy-swiper"), .prm-media:visible:not(".image-loaded"):not(".lazy-swiper")',
                lazy: '.lazy-minus'
            },
            cls: {
            ...
            adjust: function () {
                var _t = this,
                    el = $(_t.el.lazy);
                if (uty.detectEl(el) && checkPlugins('minusLazyLoad'))
                    el.each(function () {
                        var ths = $(this);
                        if (ths.hasClass(_t.cls['active'])) {
                            ths = ths.get(0);
        ...
        */
        categoryFilter: {
            ...
            init: function () {
                var _t = this;
                if (checkPlugins('MinusCategoryFilter'))
                    _t.set(_t.arr);
            }
        },
        ...
        */
        catSwiper: {
            ...
            init: function () {
                var _t = this;
                if (checkPlugins('MinusCategorySwiper')) {
                    for (var i = 0; i < _t.arr.length; ++i)
                        _t.set(_t.arr[i]);
                }
        ...
        */
        popularWorlds: {
            ...
            init: function () {
                var _t = this;
                if (checkPlugins('minusSearchPopularWorlds')) {
                    for (var i = 0; i < _t.arr.length; ++i)
                        _t.set(_t.arr[i]);
                }
        ...
        */
        customSearch: {
            ...
            init: function () {
                var _t = this;
                if (checkPlugins('minusCustomSearch'))
                    _t.set(_t.arr);
            }
        },
        ...
        */
        systemWidget: {
            ...
            adjust: function () {
                var _t = this, el = $(_t.el.con);
                if (uty.detectEl(el) && checkPlugins('minusSystemWidget'))
                    el.each(function () {
                        var ths = $(this);
            ...
            init: function () {
                var _t = this,
                    con = $(_t.el.con);
                if (uty.detectEl(con) && checkPlugins('minusSystemWidget'))
                    con
                        .each(function () {
                            _t.set($(this));
                        });
        ...
        */
        tabMenu: {
            ...
            adjust: function () {
                var _t = this, el = $(_t.el.con)
                if (uty.detectEl(el) && checkPlugins('minusTab'))
                    el.each(function () {
                        var ths = $(this);
                        if (ths.hasClass(_t.cls['active'])) {
                            ths = ths.get(0);
            ...
            init: function () {
                ...
                if (uty.detectEl(con) && checkPlugins('minusTab'))
                    con
                        .each(function () {
                            _t.set($(this));
                        });
        ...
        */
        swiper: {
            ...
            init: function () {
                var _t = this,
                    con = $(_t.el.con);
                if (uty.detectEl(con) && checkPlugins('minusSwiper'))
                    con
                        .each(function () {
                            _t.set($(this));
                        });
